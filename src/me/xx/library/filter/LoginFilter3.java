...
/**
 * Servlet Filter implementation class LoginFilter3
 */
@WebFilter(filterName="loginFilter3",urlPatterns="/librarian/*")
public class LoginFilter3 implements Filter {
	...
	public void doFilter(ServletRequest request1, ServletResponse response1, FilterChain chain) throws IOException, ServletException {
		HttpServletRequest request = (HttpServletRequest)request1;  
	     ...
	     String userName = (String) request.getSession().getAttribute("librarian");
		 if(userName==null){
