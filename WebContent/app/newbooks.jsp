...
<div class="main-nav-wrap" data-l1="3">
    <div class="main-nav box-center cf" id="type-hover">
       ...
       <ul>
            ...
            <li class="nav-li"><a href="javascript:void(0);" data-eid="qd_A16" class="act"> New Books</a></li>
...
<div id="mainbox">
	<div id="container">
	  <h5 class="box_bgcolor"><strong>New books</strong></h5>
         ...
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="table_line">
              ...
              <tr>
                ...
                <td class="greytext" width="23%">publisher</td>
                 <td class="greytext" width="22%">add date</td>
             ...
             <tr>
                ...
                <td class="whitetext"><fmt:formatDate value="${res.add_date}" pattern="yyyy-MM-dd"/></td>
...
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/BookServlet?method=findNew&&currentPage=${requestScope.pb.currentPage-1}" class="lbf-pagination-next ">&lt;</a></li>
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/BookServlet?method=findNew&&currentPage=1" class="lbf-pagination-page  lbf-pagination-current">first</a></li>
<li class="lbf-pagination-item">${pb.currentPage }/${pb.totalPage }</li>
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/BookServlet?method=findNew&&currentPage=${requestScope.pb.totalPage}" class="lbf-pagination-page  lbf-pagination-current">last</a></li>
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/BookServlet?method=findNew&&currentPage=${requestScope.pb.currentPage+1}" class="lbf-pagination-next ">&gt;</a></li>
...
function PAGINATION_goInput(){
	var page=$("#page").val();
	window.location.href = "${pageContext.request.contextPath}/BookServlet?method=findNew&&currentPage="+page+"";
}
</script>
