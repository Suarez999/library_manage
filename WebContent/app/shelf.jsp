...
<div id="mainbox">
	<div id="container">
	  <h5 class="box_bgcolor"><strong>My Reservation</strong></h5>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="table_line">
             ...
             <tr>
                ...
                <input class="btn btn-success" type="button" value="delete" onclick="delThis(${res.id},${res.book_id })"></td>
            </tr>  
            </c:forEach>
            </tbody>
            </table>
				<div style="text-align:right; padding:10px; background-color:#fefefe;">
        <span style="float:left; padding:5px;">
        <a class="btn btn-danger" href="${pageContext.request.contextPath }/ReservationServlet?method=truncate">delete all</a>
        
		</span>　　　　　　
		<div style="text-align:right; padding-right:20px;" id="bookcart_export"></div>
		  </div>
  <div class="clear"></div>
</div>
<script type="text/javascript">
	function delThis(marcNo,bookId){
		window.location.href = "${pageContext.request.contextPath}/ReservationServlet?method=delete&&id="+marcNo+"&&bookId="+bookId+"";
	}
	function login(){
