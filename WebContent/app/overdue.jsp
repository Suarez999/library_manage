  		...
  		<h2>Overdue</h2> 
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="table_line">
				...
				<tr>
					...
					<td bgcolor="#d8d8d8" class="greytext">title</td>
					<td bgcolor="#d8d8d8" class="greytext">author</td>
					<td bgcolor="#d8d8d8" class="greytext">borrow date</td>
					<td bgcolor="#d8d8d8" class="greytext">expiration date</td>
					<td bgcolor="#d8d8d8" class="greytext">fine</td>
				</tr>
				<c:forEach items="${requestScope.list }" var="book" varStatus="vs">
					<tr>
						...
						<td bgcolor="#FFFFFF" class="whitetext" width="25%"><a class="blue" href="${pageContext.request.contextPath }/BookServlet?method=findById&&id=${book.id }">${book.book_name }</a></td>
						...
						<td bgcolor="#FFFFFF" class="whitetext" width="12%"><fmt:formatDate value="${book.expiration_date}" pattern="yyyy-MM-dd"/></td>
						<td bgcolor="#FFFFFF" class="whitetext" width="15%">${book.fine }</td>
					</tr>
				</c:forEach>
			</tbody>
			</table>
