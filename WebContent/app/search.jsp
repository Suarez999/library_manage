...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/app/search/style.css">
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/app/search/mylib.css">
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/app/search/jquery-ui-1.8.13.custom.css">
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/app/search/font-awesome.css">
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/app/search/bootstrap.css">
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath }/app/search/reader-info.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/app/search/jquery.1.7.1.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/app/search/jquery-ui-1.8.13.custom.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/app/search/highlighter.js.下载"></script>

<script type="text/javascript" src="${pageContext.request.contextPath }/app/search/raphael.2.1.0.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/app/search/justgage.js.下载"></script>
...
<div class="wrap">
    <div class="top-nav" data-l1="1">
    	<div style="float:right">
    		<font size="4">hello,${sessionScope.studentName }</font>
    	</div> 
    </div>
</div>
...
<div class="main-nav-wrap" data-l1="3">
    <div class="main-nav box-center cf" id="type-hover">
        ...
        <ul>
            ...
            <li class="nav-li"><a href="javascript:void(0)" data-eid="qd_A15" >categories</a></li>
