...
<div class="main-nav-wrap" data-l1="3">
    <div class="main-nav box-center cf" id="type-hover">
        ...
        <ul>
            ...
            <li class="nav-li"><a href="${pageContext.request.contextPath }/RecommendServlet?method=getAll" class="act">Reader recommendation</a></li>
...
<div id="mainbox">
	<div id="container">
	  <h5 class="box_bgcolor"><strong>Recommendation</strong></h5>
         ...
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="table_line">
              ...
              <tr>
                ...
                <td class="greytext" width="23%">book name</td>
                 <td class="greytext" width="22%">author</td>
                <td class="greytext" width="23%">publisher</td>
             ...
             <tr>
                ...
                <td align="left" class="whitetext"><a class="blue" href="${pageContext.request.contextPath }/BookServlet?method=findById&&id=${res.book_id }">${res.book_name }</a></td>
                <td class="whitetext">${res.author }</td>
                <td class="whitetext">${res.product }</td>
                <td height="35" align="center" class="whitetext">
                <input class="btn btn-success" type="button" value="detail" onclick="detail(${res.book_id})"></td>
            </tr>  
            </c:forEach>
            </tbody>
            </table>
...
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/RecommendServlet?method=getAll&&currentPage=${requestScope.pb.currentPage-1}" class="lbf-pagination-next ">&lt;</a></li>
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/RecommendServlet?method=getAll&&currentPage=1" class="lbf-pagination-page  lbf-pagination-current">first</a></li>
<li class="lbf-pagination-item">${pb.currentPage }/${pb.totalPage }</li>
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/RecommendServlet?method=getAll&&currentPage=${requestScope.pb.totalPage}" class="lbf-pagination-page  lbf-pagination-current">last</a></li>
<li class="lbf-pagination-item"><a href="${pageContext.request.contextPath }/RecommendServlet?method=getAll&&currentPage=${requestScope.pb.currentPage+1}" class="lbf-pagination-next ">&gt;</a></li>
...
function PAGINATION_goInput(){
	var page=$("#page").val();
	window.location.href = "${pageContext.request.contextPath}/RecommendServlet?method=getAll&&currentPage="+page+"";
}
</script>
