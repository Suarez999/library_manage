...
<div id="submenu">
  ...
  <div id="navsidebar">
     <ul id="nav_mylib">
		...
		<li><a href="${pageContext.request.contextPath }/BorrowbookServlet?method=findHistoryBorrow">Borrowing history</a></li><li><a href="${pageContext.request.contextPath}/RecommendServlet?method=listRecommend">Recommended history</a></li>
		<li><a href="${pageContext.request.contextPath }/BorrowbookServlet?method=findOverdue">Overdue books</a></li>
     	...
     	<li id="nav_mylibhome"><a href="javascript:void(0);">lost books</a></li>
     </ul>
  </div>
  		...
  		<h2>lost books</h2> 
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="table_line">
				...
				<tr>
					...
					<td bgcolor="#d8d8d8" class="greytext">publisher</td>
				...
				<c:forEach items="${requestScope.list }" var="book" varStatus="vs">
					<tr>
						...
						<td bgcolor="#FFFFFF" class="whitetext" width="12%">${book.product }</td>
					</tr>
				</c:forEach>
			</tbody>
			</table>
