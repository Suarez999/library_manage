...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/sys/detail/style/images/title_arrow.gif"/> borrow history
		</div>
    </div>
...
<div id="QueryArea">
	<div style="width:600px;float:left;">
			<form action="${pageContext.request.contextPath }/BorrowbookServlet" method="get">
				<input type="hidden" name="method" value="getBorrowHistory">
				<c:choose>
		...
		<div style="width:200px;float:right;">
			<c:choose>
				<c:when test="${requestScope.pb.keyWord!=null }">
					<a href="${pageContext.request.contextPath }/BorrowbookServlet?currentPage=${requestScope.pb.currentPage-1}&&method=getBorrowHistory&&keyWord=${pb.keyWord }">last page</a>
				</c:when>
				<c:otherwise>
					<a href="${pageContext.request.contextPath }/BorrowbookServlet?currentPage=${requestScope.pb.currentPage-1}&&method=getBorrowHistory">last page</a>
				</c:otherwise>
			</c:choose>
			${requestScope.pb.currentPage }/${requestScope.pb.totalPage }
			<c:choose>
				<c:when test="${requestScope.pb.keyWord!=null }">
					<a href="${pageContext.request.contextPath }/BorrowbookServlet?currentPage=${requestScope.pb.currentPage+1}&&method=getBorrowHistory&&keyWord=${pb.keyWord }">next page</a>
				</c:when>
				<c:otherwise>
					<a href="${pageContext.request.contextPath }/BorrowbookServlet?currentPage=${requestScope.pb.currentPage+1}&&method=getBorrowHistory">next page</a>
				</c:otherwise>
			</c:choose>
		</div>
</div>
