            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							<td>isbn</td>
							<td><input type="text" name="isbn" class="InputStyle" value="${requestScope.book.isbn }" readonly="readonly"/> *</td>
						</tr>
                    	<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="name" class="InputStyle" value="${requestScope.book.name }"/> *
							</td>
						</tr>
						<tr>
							<td>state</td>
							<c:choose>
								<c:when test="${requestScope.book.book_state==1 }">
									<td>
										<input type="radio" name="book_state" value="1" checked="checked"/> Available <input type="radio" name="book_state" value="0" /> Unavailable  
									</td>
								</c:when>
								<c:otherwise>
									<td>
										<input type="radio" name="book_state" value="1" /> Available <input type="radio" name="book_state" value="0" checked="checked"/> Unavailable  
									</td>
								</c:otherwise>
							</c:choose>
						...
						<tr>
							<td>remain</td>
							<td><input type="text" name="remain" class="InputStyle" value="${requestScope.book.remain }"/> *</td>
						</tr>
						<tr>
							<td>price</td>
							<td><input type="text" name="price" class="InputStyle" value="${requestScope.book.price }"/> *</td>
						</tr>
						<tr>
							<td>author</td>
							<td><input type="text" name="author" class="InputStyle" value="${requestScope.book.author }"></td>
						</tr>
						<tr>
							<td>Production</td>
							<td><textarea name="product" class="TextareaStyle">${requestScope.book.product }</textarea></td>
						</tr>
						<tr>
							<td></td>
							<td><input type="hidden" name="id" value="${requestScope.book.id }"></td>
						</tr>
						<tr>
